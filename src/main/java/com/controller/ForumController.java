    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            BeanUtils.copyProperties( forum , view );//把实体数据重构到view中
                ...
                //级联表
                TuanzhangEntity tuanzhang = tuanzhangService.selectById(forum.getTuanzhangId());
                if(tuanzhang != null){
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setTuanzhangId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("tuanzhang_id", forum.getTuanzhangId())
...
//                            forumEntity.setTuanzhangId(Integer.valueOf(data.get(0)));   //团长 要改的
