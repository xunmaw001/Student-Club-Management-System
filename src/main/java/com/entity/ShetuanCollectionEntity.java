...
public class ShetuanCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShetuanCollectionEntity() {

	}

	public ShetuanCollectionEntity(T t) {
		try {
     ...
     * 类型
     */
    @TableField(value = "shetuan_collection_types")
    ...
    public String toString() {
        return "ShetuanCollection{" +
            "id=" + id +
            ", shetuanId=" + shetuanId +
            ", xueshengId=" + xueshengId +
            ", shetuanCollectionTypes=" + shetuanCollectionTypes +
