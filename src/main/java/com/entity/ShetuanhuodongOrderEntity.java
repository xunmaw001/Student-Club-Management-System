...
public class ShetuanhuodongOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShetuanhuodongOrderEntity() {

	}

	public ShetuanhuodongOrderEntity(T t) {
		try {
    ...
    private String shetuanhuodongOrderYesnoText;
    ...
    public String getShetuanhuodongOrderYesnoText() {
        return shetuanhuodongOrderYesnoText;
    }

    public void setShetuanhuodongOrderYesnoText(String shetuanhuodongOrderYesnoText) {
    ...
    public String toString() {
        return "ShetuanhuodongOrder{" +
            "id=" + id +
            ", shetuanhuodongOrderUuidNumber=" + shetuanhuodongOrderUuidNumber +
            ", shetuanhuodongId=" + shetuanhuodongId +
            ", xueshengId=" + xueshengId +
            ", shetuanhuodongOrderYesnoTypes=" + shetuanhuodongOrderYesnoTypes +
            ", shetuanhuodongOrderYesnoText=" + shetuanhuodongOrderYesnoText +
