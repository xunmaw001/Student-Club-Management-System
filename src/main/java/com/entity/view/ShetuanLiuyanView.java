...
public class ShetuanLiuyanView extends ShetuanLiuyanEntity implements Serializable {
	...
	public ShetuanLiuyanView() {

	}

	public ShetuanLiuyanView(ShetuanLiuyanEntity shetuanLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, shetuanLiuyanEntity);
