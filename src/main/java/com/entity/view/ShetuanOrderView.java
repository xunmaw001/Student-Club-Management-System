...
public class ShetuanOrderView extends ShetuanOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核状态的值
		*/
		private String shetuanOrderYesnoValue;
	...
	public ShetuanOrderView() {

	}

	public ShetuanOrderView(ShetuanOrderEntity shetuanOrderEntity) {
		try {
			BeanUtils.copyProperties(this, shetuanOrderEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getShetuanOrderYesnoValue() {
				return shetuanOrderYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setShetuanOrderYesnoValue(String shetuanOrderYesnoValue) {
				this.shetuanOrderYesnoValue = shetuanOrderYesnoValue;
			}
