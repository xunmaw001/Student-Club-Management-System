...
public class ShetuanhuodongCollectionView extends ShetuanhuodongCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String shetuanhuodongCollectionValue;
	...
	public ShetuanhuodongCollectionView() {

	}

	public ShetuanhuodongCollectionView(ShetuanhuodongCollectionEntity shetuanhuodongCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, shetuanhuodongCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getShetuanhuodongCollectionValue() {
				return shetuanhuodongCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setShetuanhuodongCollectionValue(String shetuanhuodongCollectionValue) {
				this.shetuanhuodongCollectionValue = shetuanhuodongCollectionValue;
			}
