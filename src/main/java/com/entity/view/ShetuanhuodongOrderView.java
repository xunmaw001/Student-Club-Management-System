...
public class ShetuanhuodongOrderView extends ShetuanhuodongOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核状态的值
		*/
		private String shetuanhuodongOrderYesnoValue;
	...
	public ShetuanhuodongOrderView() {

	}

	public ShetuanhuodongOrderView(ShetuanhuodongOrderEntity shetuanhuodongOrderEntity) {
		try {
			BeanUtils.copyProperties(this, shetuanhuodongOrderEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getShetuanhuodongOrderYesnoValue() {
				return shetuanhuodongOrderYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setShetuanhuodongOrderYesnoValue(String shetuanhuodongOrderYesnoValue) {
				this.shetuanhuodongOrderYesnoValue = shetuanhuodongOrderYesnoValue;
			}
