            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.tuanzhangId">
                            团长
                        </span>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shetuanguanli/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.tuanzhangId = el.tuanzhangId;//---
                            forum.tuanzhangName = el.tuanzhangName;
                            forum.tuanzhangPhone = el.tuanzhangPhone;
                            forum.tuanzhangIdNumber = el.tuanzhangIdNumber;
                            forum.tuanzhangPhoto = el.tuanzhangPhoto;
                            forum.tuanzhangEmail = el.tuanzhangEmail;
                            forum.createTime = el.createTime;
