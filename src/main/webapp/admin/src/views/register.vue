<template>
    <div style="backgroundImage: url('/shetuanguanli/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">学生社团管理系统</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='tuanzhang'">
                            <el-input v-model="ruleForm.tuanzhangEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.tuanzhangName)&& 'tuanzhang'==this.tableName){
