...
var centerMenu = [
    ...
    ,{
        name: '社团收藏',
        url: '../shetuanCollection/list.html'
    }
    ,{
        name: '社团申请',
        url: '../shetuanOrder/list.html'
    }
    ,{
        name: '社团活动收藏',
        url: '../shetuanhuodongCollection/list.html'
    }
    ,{
        name: '社团活动申请',
        url: '../shetuanhuodongOrder/list.html'
    }
...
var adminurl =  "http://localhost:8080/shetuanguanli/admin/dist/index.html#/login";
